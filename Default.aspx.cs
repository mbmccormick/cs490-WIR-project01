    ...
    public partial class Default : System.Web.UI.Page
    {
        ...
        private string LoadSongs(string path, int category)
        {
            ...
            foreach (KeyValuePair<int, double> song in songs.Take(5))
            {
                ...
                output += "<div class='span2'><img class='img-polaroid' width='150' height='150' src='" + albumCover + "'></a><h4><a href='View.aspx?id=" + track.track_id + "&category=" + category + "'>" + track.track_name + "</a></h4><p>by " + track.artist_name + "</p></div>\n";
            }
